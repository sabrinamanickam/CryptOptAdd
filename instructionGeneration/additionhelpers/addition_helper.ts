...
export function fr__rm_rm_rmf( //done
    ...
    if (cinFlag) {
      return hasCout
        ? [
            ...
            ...fr__r_r_f(cout, out, a0, a1, cin as U1FlagAllocation),//fr__r_rm_f //done with add
          ]
        : r__r_r_f(out, a0, a1, cin as U1FlagAllocation); //r__r_rm_f //done with adc
    }
    if (cinMem) {
      return hasCout
        ? fr__r_r_m(cout, out, a0, a1, cin as U1MemoryAllocation) //fr__r_rm_rm //done with add
        : r__r_r_m(out, a0, a1, cin as U1MemoryAllocation); //done wiht lea
    }

    if (cinReg) {
      return hasCout
        ? fr__r_r_r(cout, out, a0, a1, cin as U1RegisterAllocation) //done with add
        : r__r_r_r(out, a0, a1, cin as U1RegisterAllocation);//done with lea
    }
  ...
  if (reg0 !== reg1) {
    ...
    if (cinFlag) {
      return hasCout
        ? fr__r_m_f(cout, out, a0, a1, cin as U1FlagAllocation)//done 
        : r__r_m_f(out, a0, a1, cin as U1FlagAllocation);//done
    }
    if (cinMem) {
      return hasCout
        ? fr__r_m_m(cout, out, a0, a1, cin as U1MemoryAllocation)//done
        : r__r_m_m(out, a0, a1, cin as U1MemoryAllocation);//done
    }
    if (cinReg) {
      return hasCout
        ? fr__r_m_r(cout, out, a0, a1, cin as U1RegisterAllocation)//done
        : r__r_m_r(out, a0, a1, cin as U1RegisterAllocation);//done
    }
    throw new Error("cannot handle cin not in mem/flag/reg");
  }
  ...
  if (!reg0 && !reg1) {
    ...
    if (cinFlag) {
      return hasCout
        ? fr__m_m_f(cout, out, a0, a1, cin as U1FlagAllocation)//done
        : r__m_m_f(out, a0, a1, cin as U1FlagAllocation);//done
    }
    if (cinMem) {
      return hasCout
        ? fr__m_m_m(cout, out, a0, a1, cin as U1MemoryAllocation)//done
        : r__m_m_m(out, a0, a1, cin as U1MemoryAllocation);//done
    }
    if (cinReg) {
      return hasCout
        ? fr__m_m_r(cout, out, a0, a1, cin as U1RegisterAllocation)//done
        : r__m_m_r(out, a0, a1, cin as U1RegisterAllocation);//done
    }
    throw new Error("cannot handle cin not in mem/flag/reg");
  }
...
export function r__rmf_rmf(out: string, arg0: ValueAllocation, arg1: ValueAllocation): asm[] {
  ...
  if (flag0 && flag1) {
    // ff
    return r__f_f(out);//done
  }
  if (mem0 && mem1) {
    //mm
    return r__m_m(out, arg0 as MemoryAllocation, arg1 as MemoryAllocation); //done
  }
  if (reg0 && reg1) {
    //rr
    return r__r_r(out, arg0 as RegisterAllocation, arg1 as RegisterAllocation);//done
  }

  if (mem0 && flag1) {
    // mf
    return r__m_f(out, arg0 as MemoryAllocation, arg1 as U1FlagAllocation);//done
  }
  if (flag0 && mem1) {
    // fm-mf NOTE the argument swap
    return r__m_f(out, arg1 as MemoryAllocation, arg0 as U1FlagAllocation);//done
  }

  if (reg0 && mem1) {
    // rm
    return r__r_m(out, arg0 as RegisterAllocation, arg1 as MemoryAllocation);//done
  }
  if (mem0 && reg1) {
    // mr NOTE the argument swap
    return r__r_m(out, arg1 as RegisterAllocation, arg0 as MemoryAllocation);//done
  }

  if (reg0 && flag1) {
    // rf
    return r__r_f(out, arg0 as RegisterAllocation, arg1 as U1FlagAllocation);//done
  }
  if (flag0 && reg1) {
    // fr NOTE the argument swap
    return r__r_f(out, arg1 as RegisterAllocation, arg0 as U1FlagAllocation);//done
  }
