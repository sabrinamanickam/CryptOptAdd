...
function add64(c: CryptOpt.StringOperation): asm[] {
  ...
  if (c.operation === "addcarryx") {
    ...
    if (c.arguments[0] === "0x0") {
      ...
      return [";fr__rm_rm", ...fr__rm_rm(c.name[1] /* COUT */, c.name[0], a_arg1, a_arg2)]; //this is good
    }
    ...
    if (c.name[1] === "_") {
      ...
      if (both_u1_are_flags) {
        return [";r__rm_f_f", ...r__rm_f_f(c.name[0], a_arg1)];//Sabs: This is good
      }
      return [";r__rm_rm_f", ...r__rm_rm_rmf(c.name[0], a_arg1, a_arg2, a_cin /* CarryIN */)];//done
    } else {
      ...
      if (both_u1_are_flags) {
        return ["; fr_rm_f_f", ...fr_rm_f_f(c.name[1] /* COUT */, c.name[0], a_arg1)]; //done
      }
    ...
    //
    return [`; r__rm_rm_rmf`, ...r__rmf_rmf(c.name[0], a_arg0, a_arg1)];//done
  }
}
